            ...
            <div class="container">
              ...
              <div class="col-md-12">
                ...
                <p style={{ paddingTop: "20px", textAlign: "center" }}>
                  You won’t find “fake news” here. WiseWallet collects
                  verifiable factual data from Non-Governmental Organizations
                  (NGO’s), trustworthy databases, company benefits packages,
                  financial statements, and other reliable data sources. We are
                  fully transparent regarding the methodology and the data
              ...
              <div class="col-md-12">
                ...
                <div class="simpborder"></div>
                <p style={{ paddingTop: "20px", textAlign: "center" }}>
                  Not yet, but we plan to apply as soon as it's feasible. We are
                  building WiseWallet with both purpose and profit in mind.
                </p>
              </div>
            </div>
          </section>
          ...
          content={
            <div>
              ...
              <CustomButton
                justIcon="justIcon"
                simple="simple"
                href="https://www.facebook.com/mywisewallet"
                color="facebook"
              >
